...
--
-- Host: localhost    Database: Halonesia
-- ------------------------------------------------------
...
CREATE TABLE `Users` (
  ...
  `FullName` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `NeedToChangePassword` tinyint(1) DEFAULT NULL,
...
-- Dump completed on 2017-05-26 14:05:45
